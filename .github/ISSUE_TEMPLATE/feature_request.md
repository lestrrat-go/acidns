...
Before filing an issue, please read the contents of [CONTRIBUTING.md](https://github.com/lestrrat-go/acidns/blob/main/.github/CONTRIBUTING.md), and follow its instructions.
...
If it's a behavior change, please include a failing (or would-be failing) test case. If it's a structural or an API change, we understand that you cannot create a complete compiling code, but please do your best to produce a near-valid code that shows exactly what you want.
