...
* 💬 Open-ended questions and inquiries go to [Discussions](https://github.com/lestrrat-go/acidns/discussions).
* 🖥️ Actionable, specific technical questions go to [Issues](https://github.com/lestrrat-go/acidns/issues).
...
This project uses [GitHub Issues](https://github.com/lestrrat-go/acidns/issues) to deal with technical issues
...
questions/discussions should be posted to [GitHub Discussions](https://github.com/lestrrat-go/acidns/discussions).
...
Development happens against the `main` branch. Fork it, make your changes on a
...
sequenceDiagram
  ...
  main->>feature_branch: Fork main to your feature branch
  Note over feature_branch: Work on your feature
  feature_branch->>main: File a PR against main
  main->>main: Merge changes
```
