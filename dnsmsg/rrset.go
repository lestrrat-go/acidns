...
func (s rrset) Name() dnsname.Name  { return s.name }
...
// TTL.
func NewRRsetFromRDatas(name dnsname.Name, class rrtype.Class, ttl time.Duration, rds ...rdata.RData) (RRset, error) {
	if len(rds) == 0 {
