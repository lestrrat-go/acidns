...
func TestRP(t *testing.T) {
	t.Parallel()
	r := rdata.NewRP(dnsname.MustParse("admin.example.com"), dnsname.MustParse("info.example.com"))
...
func TestAFSDB(t *testing.T) {
	t.Parallel()
	r := rdata.NewAFSDB(1, dnsname.MustParse("afs.example.com"))
...
func TestRT(t *testing.T) {
	t.Parallel()
	r := rdata.NewRT(10, dnsname.MustParse("relay.example.com"))
...
func TestNSAPPTR(t *testing.T) {
	t.Parallel()
	r := rdata.NewNSAPPTR(dnsname.MustParse("foo.nsap.arpa"))
