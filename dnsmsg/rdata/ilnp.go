...
func unpackNID(u *wire.Unpacker) (NID, error) {
	pref, err := u.Uint16()
	if err != nil {
		return nil, err
	}
...
func unpackL32(u *wire.Unpacker) (L32, error) {
	pref, err := u.Uint16()
	if err != nil {
		return nil, err
	}
...
func unpackL64(u *wire.Unpacker) (L64, error) {
	pref, err := u.Uint16()
	if err != nil {
		return nil, err
	}
...
func (l lp) FQDN() dnsname.Name { return l.fqdn }
func (l lp) Pack(p *wire.Packer) {
	p.Uint16(l.pref)
...
func NewLP(pref uint16, fqdn dnsname.Name) LP { return lp{pref: pref, fqdn: fqdn} }

func unpackLP(u *wire.Unpacker) (LP, error) {
	pref, err := u.Uint16()
	if err != nil {
		return nil, err
	}
