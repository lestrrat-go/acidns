...
func TestCNAME(t *testing.T) {
	t.Parallel()
	r := rdata.NewCNAME(dnsname.MustParse("alias.example.com"))
...
func TestNS(t *testing.T) {
	t.Parallel()
	r := rdata.NewNS(dnsname.MustParse("ns1.example.com"))
...
func TestPTR(t *testing.T) {
	t.Parallel()
	r := rdata.NewPTR(dnsname.MustParse("host.example.com"))
...
func TestMX(t *testing.T) {
	t.Parallel()
	r := rdata.NewMX(10, dnsname.MustParse("mail.example.com"))
...
func TestSOA(t *testing.T) {
	...
	r := rdata.NewSOA(
		...
		dnsname.MustParse("hostmaster.example.com"),
		2024010100,
		3600*time.Second,
		600*time.Second,
		86400*time.Second,
