...
func (t tlsa) Pack(p *wire.Packer) {
...
func unpackTLSA(u *wire.Unpacker, rdlen int) (TLSA, error) {
	usage, err := u.Uint8()
	if err != nil {
		return nil, err
	}
...
func (s smimea) Pack(p *wire.Packer) {
...
func unpackSMIMEA(u *wire.Unpacker, rdlen int) (SMIMEA, error) {
	usage, err := u.Uint8()
	if err != nil {
		return nil, err
	}
